...
class MailServiceTest {
    ...
    void sendAttachmentsMail() throws Exception {
        ...
        // 本地文件
        File file1 = new File("/Users/liuliu/IdeaProjects/spring-boot-course/spring-boot-config/src/main/java/com/example/boot/config/img/1.png");
        File file2 = new File("/Users/liuliu/IdeaProjects/spring-boot-course/spring-boot-config/src/main/java/com/example/boot/config/img/2.png");
